...
namespace GS.Trade.Strategies
{
    public class Z00736Ti22 : Z007
    {
        ...
        private bool ShortEntry(int signal)
        {
            ...
            //    return false;
            if (
                (TrEntryEnabled.Value && signal == 0 && Mode == 1 && (TakeShort(EntrySignal11) || TakeShort(EntrySignal12))) ||
                //(TrEntryEnabled.Value && signal == 0 && Mode == 2 && Position.IsShort && (TakeShort(EntrySignal21) || TakeShort(EntrySignal22))) ||
                (TrEntryEnabled2 != null && TrEntryEnabled2.Value && signal == 0 && Mode == 2 && Position.IsShort && (TakeShort2(EntrySignal21) || TakeShort2(EntrySignal22))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 2 && Position.IsLong && (TakeShort(EntrySignal23) || TakeShort(EntrySignal24))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 3 && Position.IsShort && (TakeShort(EntrySignal31) || TakeShort(EntrySignal32))) ||
                (TrEntryEnabled2 != null && TrEntryEnabled2.Value && signal == 0 && Mode == 3 && Position.IsLong && (TakeShort2(EntrySignal33) || TakeShort2(EntrySignal34))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 5 && Position.IsShort && (TakeShort(EntrySignal51) || TakeShort(EntrySignal52))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 5 && Position.IsLong && (TakeShort(EntrySignal53) || TakeShort(EntrySignal54))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 4 && Position.IsShort && (TakeShort(EntrySignal41) || TakeShort(EntrySignal42))) ||
                (TrEntryEnabled2 !=null && TrEntryEnabled2.Value && signal == 0 && Mode == 4 && Position.IsLong && (TakeShort2(EntrySignal43) || TakeShort2(EntrySignal44))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 8 && Position.IsShort && (TakeShort(EntrySignal81) || TakeShort(EntrySignal82))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 8 && Position.IsLong && (TakeShort(EntrySignal83) || TakeShort(EntrySignal84))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 9 && Position.IsLong && (TakeShort(EntrySignal93) || TakeShort(EntrySignal94))) ||
        ...
        private bool LongEntry(int signal)
        {
            ...
            //    return false;
            if (
                (TrEntryEnabled.Value && signal == 0 && Mode == 1 && (TakeLong(EntrySignal11) || TakeLong(EntrySignal12))) ||
                //(TrEntryEnabled.Value && signal == 0 && Mode == 2 && Position.IsLong && (TakeLong(EntrySignal21) || TakeLong(EntrySignal22))) ||
                (TrEntryEnabled2 != null && TrEntryEnabled2.Value && signal == 0 && Mode == 2 && Position.IsLong && (TakeLong2(EntrySignal21) || TakeLong2(EntrySignal22))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 2 && Position.IsShort && (TakeLong(EntrySignal23) || TakeLong(EntrySignal24))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 3 && Position.IsLong && (TakeLong(EntrySignal31) || TakeLong(EntrySignal32))) ||
                (TrEntryEnabled2 != null && TrEntryEnabled2.Value && signal == 0 && Mode == 3 && Position.IsShort && (TakeLong2(EntrySignal33) || TakeLong2(EntrySignal34))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 5 && Position.IsLong && (TakeLong(EntrySignal51) || TakeLong(EntrySignal52))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 5 && Position.IsShort && (TakeLong(EntrySignal53) || TakeLong(EntrySignal54))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 4 && Position.IsLong && (TakeLong(EntrySignal41) || TakeLong(EntrySignal42))) ||
                (TrEntryEnabled2 != null && TrEntryEnabled2.Value && signal == 0 && Mode == 4 && Position.IsShort && (TakeLong2(EntrySignal43) || TakeLong2(EntrySignal44))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 8 && Position.IsLong && (TakeLong(EntrySignal81) || TakeLong(EntrySignal82))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 8 && Position.IsShort && (TakeLong(EntrySignal83) || TakeLong(EntrySignal84))) ||
                (TrEntryEnabled.Value && signal == 0 && Mode == 9 && Position.IsShort && (TakeLong(EntrySignal93) || TakeLong(EntrySignal94))) ||
