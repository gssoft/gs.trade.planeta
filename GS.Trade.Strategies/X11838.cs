       ...
       public class X11838 : X118
    {
        ...
        protected override int Entry()
        {
            ...
            else if (EntryMode == -15 && _mode == 1 && _richTarget1)
            {
                ...
                else if (TakeShort(EntrySignal12) /* && IsLongTermBreakDown */&& IsEntryRiskLow1(-1))
                {
                    entrySignal = EntrySignal12;
                    buysell = -1;
                }
                else if (TakeLong(EntrySignal12) /* && IsLongTermBreakUp */&& IsEntryRiskLow1(+1))
                {
                    entrySignal = EntrySignal12;
                    buysell = +1;
                }
