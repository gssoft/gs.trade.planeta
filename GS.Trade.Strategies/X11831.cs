    ...
    public class X11831 : X118
    {
        ...
        protected override bool ShortEntry()
        {
            ...
            else if (EntryMode == -2)
            {
                ...
                if (XTrend.TakeShort(EntrySignal11) &&  IsLongTermBreakDown)
                    entrySignal = EntrySignal11;
                else if (XTrend.TakeShort(EntrySignal12) && !IsLongTermBreakUp)
        ...
        protected override bool LongEntry()
        {
            ...
            else if (EntryMode == -2)
            {
                //entrySignal = EntrySignal11;
                entryMode = 1;
                if (XTrend.TakeLong(EntrySignal11) && IsLongTermBreakUp)
                    entrySignal = EntrySignal11;
                else if (XTrend.TakeLong(EntrySignal12) && ! IsLongTermBreakDown)
                    entrySignal = EntrySignal12;
        ...
        protected override bool ShortReverse()
        {
            ...
            if (_mode == 1 && _richTarget1 && IsMyPositionRiskLow && XTrend.TakeLong(ReverseSignal1) && _swingCountReverse >= SwingCountReverse)
            {
            ...
            if (_mode == 2 && _richTarget1 && IsMyPositionRiskLow && XTrend.TakeLong(ReverseSignal2) && _swingCountReverse >= SwingCountReverse)
            {
                if (XTrend.GetPrice5(+1, ReversePriceId, out _currentLimitPrice, out _comment))
                {
        ...
        protected override bool LongReverse()
        {
            ...
            if (_mode == 1 && _richTarget1 && IsMyPositionRiskLow && XTrend.TakeShort(ReverseSignal1) && _swingCountReverse >= SwingCountReverse)
            {
                if (XTrend.GetPrice5(-1, ReversePriceId, out _currentLimitPrice, out _comment))
                {
            ...
            // Reverse After Profit
            if (_mode == 2 && _richTarget1 && IsMyPositionRiskLow && XTrend.TakeShort(ReverseSignal2) && _swingCountReverse >= SwingCountReverse)
            {
                if (XTrend.GetPrice5(-1, ReversePriceId, out _currentLimitPrice, out _comment))
                {
