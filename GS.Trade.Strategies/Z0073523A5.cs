...
namespace GS.Trade.Strategies
{
    public class Z0073523A5 : Z007
    {
        ...
        protected override int Entry()
        {
            ...
            // if (Position.IsNeutral && (LastSignalActivated == 19 || LastSignalActivated == 1010)) // && _swingCountEntry < 1)
            if (Position.IsNeutral && LastSignalActivated == 19)
            {
