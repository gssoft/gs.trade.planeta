...
namespace GS.Trade.Strategies
{
    public class Z00738H : Z007
    {
        ...
        protected override bool IsPosMinReached =>
                        !PositionMin.HasValue ||
                        (XTrend != null && XTrend.Ma.IsLessThan(PositionMin.GetValidValue));

        protected override bool IsPosMaxReached =>
                        !PositionMax.HasValue ||
        ...
        protected override void CalcPosMinMax()
        {
            ...
            //    // 07.04.2018
            //    // Reset after enter to Profit Area from Loss area
            //    if (PrimTrend != null && PrimTrend.IsDown &&
            //        XTrend.IsDown &&
            //        XTrend.PrevMa.IsGreaterOrEqualsThan((double)Position.Price1) &&
            ...
            //    // 07.04.2018
            //    if (PrimTrend != null && PrimTrend.IsUp &&
            //        XTrend.IsDown &&
            //        XTrend.PrevMa.IsGreaterOrEqualsThan((double)Position.Price1) &&
            //        XTrend.Ma.IsLessThan((double)Position.Price1))
            //    {
        ...
        private bool ShortEntry(int signal)
        {
            ...
            if (!TrEntryEnabled.Value)
                return false;
            if (
                (signal == 0 && Mode == 1 && IsPrimTrendUp && (TakeShort(EntrySignal11) || TakeShort(EntrySignal12))) ||
                //(signal == 0 && Mode == 1 && !IsPrimTrendImpulseUp && (TakeShort(EntrySignal11) || TakeShort(EntrySignal12))) ||
        ...
        private bool LongEntry(int signal)
        {
            ...
            if (!TrEntryEnabled.Value)
                return false;
            if (
                 (signal == 0 && Mode == 1 && IsPrimTrendDown && (TakeLong(EntrySignal11) || TakeLong(EntrySignal12))) ||
                //(signal == 0 && Mode == 1 && !IsPrimTrendImpulseDown && (TakeLong(EntrySignal11) || TakeLong(EntrySignal12))) ||
        ...
        protected bool IsTotalDailyPnlPositive => Position.DailyCurrentPnL > 0m ;
        ...
        //    ((IsLongEntryUpToTrend && Position.IsLong) || (IsShortEntryUpToTrend && Position.IsShort));
        ...
        protected bool IsPosUpToPrimTrend =>
            (Position.IsLong && IsPrimTrendUp) || (Position.IsShort && IsPrimTrendDown);
