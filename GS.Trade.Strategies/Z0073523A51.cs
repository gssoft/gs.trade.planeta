            ...
            if (Position.IsOpened )
            {
                ...
                else if (Position.Quantity >= Contracts)
                {
                    if (IsPosPositive)
                    {
                        ...
                        {
                            // 2018.08.25
                            // Remove because After Enter in Negative this is Clear
                            // Let's going to Clean Mode = 5? becuse we have M58 system instead
                            //  Restore because We have 73523A5 system
