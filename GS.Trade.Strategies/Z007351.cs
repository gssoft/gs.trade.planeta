            ...
            if (Position.IsOpened )
            {
                if (Position.Quantity < Contracts)
                {
                                ...
                                (Mode == 2 && (_previousMode == 3 || _previousMode == 4 || _previousMode == 5 /*|| _previousMode == 8 */)))
                    {
                        ...
                        {
                            if (
                                (Position.IsLong && XTrend.Ma.IsGreaterThan(PositionMin.GetValidValue)) ||
                                (Position.IsShort && XTrend.Ma.IsLessThan(PositionMax.GetValidValue))
                               )
                            {
                                Mode = 8;
                            }
