...
namespace GS.Trade.Strategies
{
    public class X11839 : X118
    {
        ...
        public int RichTargetMode01 { get; set; }
        ...
        public int RichTargetMode17 { get; set; }
        ...
        public int RichTargetMode101 { get; set; }
        ...
        public int ExitSignal42 { get; set; }
        ...
        public int ModeEnabled10 { get; set; }

        public int ExitSignal101 { get; set; }
        public int ExitSignal102 { get; set; }
        ...
        public int ChangeModeCondSignal0 { get; set; }
        ...
        private bool IsEntryRiskLow1(int operation)
        {
            double low, high;
        ...
        private bool IsEntryRiskLow3(int operation)
        {
            double low, high;
            var kAtrStop = KAtrStop1 + KAtrStop2;
            ...
            switch (operation)
            {
                case +1:
                    ...
                    {
                        var r = XTrend.Low - low;
                        if (r.CompareTo((double)VolatilityUnit2 * kAtrStop) < 0)
                        {
                            _positionMin = (float)low;
                            _positionStop = ((float)XTrend.Low - VolatilityUnit2 * kAtrStop);
                            
                            return true;
                        }
                        _positionMin = _positionStop = (float)XTrend.Low - VolatilityUnit2 * kAtrStop;
                        return true;
                    }
                    _positionMin = _positionStop = (float)XTrend.Low - VolatilityUnit2 * kAtrStop;
                    return true;
                case -1:
                    if (XTrend.HaveHigher((int)TimeInt * 60 * KMinFarFromHere, XTrend.High, out high))
                    {
                        ...
                        {
                            _positionMax = (float)high;
                            _positionStop = ((float)XTrend.High + VolatilityUnit2 * kAtrStop);
                            
                            return true;
                        }
                        _positionMax = _positionStop = (float)XTrend.High + VolatilityUnit2 * kAtrStop;
                        return true;
                    }
                    _positionMax = _positionStop = (float)XTrend.High + VolatilityUnit2 * kAtrStop;
                    return true;
        ...
        private bool IsEntryRiskLow5(int operation)
        {
            double low, high;
        ...
        protected override void Prefix()
        {
            ...
            if (!_richTargetCalcEnable)
            {
                ...
                {
                    if ((XTrend.IsUp2 && XTrend.IsDown) || (XTrend.IsDown2 && XTrend.IsUp))
                    {
                        _richTargetCalcEnable = true;
                    }
                    //if ((XTrend.IsUp2 && XTrend.IsUp) || (XTrend.IsDown2 && XTrend.IsDown))
                    //{
                    //    _richTargetCalcEnable = true;
                    //}
                }
                //if(_richTargetCalcEnable)
                //    _swingCountEntry = SwingCountEntry - 2;
            }
            if (_mode == 0 && Position.IsNeutral)
            {
                switch (RichTargetMode01)
                {
                    case 0:
                        _richTarget2 = false;
                        break;
                    case 1:
                        ...
                        break;
                    case 2:
                        if (XTrend.IsUp2 && XTrend.IsUp)
                        {
                            _richTarget2 = true;
                        }
                        else if (XTrend.IsDown2 && XTrend.IsDown)
                        {
                            _richTarget2 = true;
                        }
                        break;
                    case 3:
                        if (XTrend.IsUp2 && XTrend.IsDown)
                        {
                            _richTarget2 = true;
                        }
                        else if (XTrend.IsDown2 && XTrend.IsUp)
                        {
                            _richTarget2 = true;
                        }
                        break;
            ...
            else if (_mode == 1 && _richTargetCalcEnable)
            {
                ...
                else if (Position.IsNeutral && _swingCountEntry >= SwingCountEntry)
                {
                    switch (RichTargetMode17)
                    {
                        case 0:
                            _richTarget1 = false;
                            break;
            ...
            else if (_mode == 2 && _richTargetCalcEnable && Position.IsOpened)
            {
            ...
            else if (_mode == 3 && _richTargetCalcEnable && Position.IsOpened)
            {
            ...
            else if (_mode == 4 && Position.IsOpened) //&& _richTargetCalcEnable)
            {
            ...
            else if (_mode == 5 && _richTargetCalcEnable && Position.IsOpened)
            {
            ...
            else if (_mode == 6 && Position.IsOpened) //&& _richTargetCalcEnable)
            {
            ...
            else if (_mode == 10 && Position.IsOpened)
            {
                switch (RichTargetMode101)
                {
                    case 0:
                        _richTarget1 = false;
                        break;
        ...
        protected override int Entry()
        {
            ...
            if (EntryMode == -5)
            {
                ...
                if (TakeShort(EntrySignal11) && IsEntryRiskLow5(-1))
                {
                ...
                if (TakeShort(EntrySignal12) && IsEntryRiskLow5(-1))
                {
                ...
                if (TakeLong(EntrySignal11) && IsEntryRiskLow5(+1))
                {
                    r1 = -_positionStop + (float)ma;
                    pStop1 = _positionStop;
                    pMin1 = _positionMin;
                ...
                if (TakeLong(EntrySignal12) && IsEntryRiskLow5(+1))
                {
                    r2 = -_positionStop + (float)ma;
                    pStop2 = _positionStop;
                    pMin2 = _positionMin;
            ...
            else if (EntryMode == -15 && _mode == 1 && _richTarget1)
            {
                int entrySignal = 0;
                int entryMode = 0;
                int buysell = 0;

                if (TakeShort(EntrySignal11) /* && IsLongTermBreakDown */&& IsEntryRiskLow1(-1))
                {
                    entrySignal = EntrySignal11;
                    buysell = -1;
                }
                else if (TakeLong(EntrySignal11) /* && IsLongTermBreakUp */&& IsEntryRiskLow1(+1))
                {
                    entrySignal = EntrySignal11;
                    buysell = +1;
                }
                else if (TakeShort(EntrySignal12) /* && IsLongTermBreakDown */&& IsEntryRiskLow3(-1))
                {
                    entrySignal = EntrySignal12;
                    buysell = -1;
                }
                else if (TakeLong(EntrySignal12) /* && IsLongTermBreakUp */&& IsEntryRiskLow3(+1))
                {
                    entrySignal = EntrySignal12;
                    buysell = +1;
                }
                ...
                if( _positionStop.CompareTo(0.0f) == 0)
                    throw new NullReferenceException("PositionStop is Null");

                if (entrySignal == 0 || buysell == 0)
                    return 0;

                if (ShortEnabled && buysell < 0 && TakeShort(entrySignal) && _swingCountEntry >= SwingCountEntry)
                {
                    //if (_currentLimitPrice.CompareTo(ShortEntryLevel) <= 0)
                    //    return 0;
                ...
                if (LongEnabled && buysell > 0 && TakeLong(entrySignal) && _swingCountEntry >= SwingCountEntry)
                {
                    //if (_currentLimitPrice.CompareTo(LongEntryLevel) >= 0)
                    //    return 0;
                    if (XTrend.GetPrice5(+1, EntryPriceId, out _currentLimitPrice, out _comment))
                    {
                        _comment = "Long Entry:[" + entrySignal + "] " + _comment;
        ...
        protected override bool ShortEntry()
        {
            ...
            else if (EntryMode == -4)
            {
                ...
                if (TakeShort(EntrySignal11) /* && IsLongTermBreakDown */ && IsEntryRiskLow5(-1))
                    entrySignal = EntrySignal11;
                else if (TakeShort(EntrySignal12) /* && !IsLongTermBreakUp */ && IsEntryRiskLow5(-1))
                    entrySignal = EntrySignal12;
                else if (TakeShort(EntrySignal13))
                    entrySignal = EntrySignal13;
                else
            ...
            else if (EntryMode == -5 || EntryMode == -7)
                return false;
        ...
        protected override bool LongEntry()
        {
            ...
            else if (EntryMode == -4)
            {
                //entrySignal = EntrySignal11;
                entryMode = 1;
                if (TakeLong(EntrySignal11) /* && IsLongTermBreakUp */ && IsEntryRiskLow5(+1))
                    entrySignal = EntrySignal11;
                else if (TakeLong(EntrySignal12) /* && !IsLongTermBreakDown */ && IsEntryRiskLow5(+1))
                    entrySignal = EntrySignal12;
                else if (TakeLong(EntrySignal13))
                    entrySignal = EntrySignal13;
                else
        ...
        protected override bool ShortExit()
        {
            ...
            if (_mode == 4 && _richTarget1 && (TakeLong(ExitSignal4) || TakeLong(ExitSignal42)) )
            {
                if (XTrend.GetPrice5(+1, ExitPriceId, out _currentLimitPrice, out _comment))
                {
            ...
            */
            ...
            //    }
            //}
            if (_mode == 10 && _richTarget1 && (TakeLong(ExitSignal101) || TakeLong(ExitSignal102)))
            {
                if (XTrend.GetPrice5(+1, ExitPriceId, out _currentLimitPrice, out _comment))
                {
                    _tryEnterMode = -1;
        ...
        protected override bool LongExit()
        {
            ...
            if (_mode == 4 && _richTarget1 && (TakeShort(ExitSignal4) || TakeShort(ExitSignal42)) )
            {
                if (XTrend.GetPrice5(-1, ExitPriceId, out _currentLimitPrice, out _comment))
                {
            ...
            */
            ...
            //    }
            //}
            if (_mode == 10 && _richTarget1 && (TakeShort(ExitSignal101) || TakeShort(ExitSignal102)))
            {
                if (XTrend.GetPrice5(-1, ExitPriceId, out _currentLimitPrice, out _comment))
                {
                    _tryEnterMode = -1;
        ...
        private bool ChangeMode()
        {
            if (Position.IsLong)
            {
                ...
                if (_mode != 10 && ModeEnabled10 > 0
                    && ((Portfolio == null) || (Portfolio != null && Portfolio.IsLong))
                    && PositionStopValid 
                    && XTrend.Ma.CompareTo((double)PositionStop) < 0)
                {
                    _mode = 10;
                    _modeLast = (_mode == 1 || _mode == 2) ? _mode : _modeLast;
                    ClearTargets();
            ...
            else if (Position.IsShort)
            {
                ...
                if (_mode != 6 
                    && (Portfolio != null && !Portfolio.IsShort) 
                    && PositionStopValid && XTrend.Ma.CompareTo((double)PositionStop) > 0)
                {
                    _mode = 6;
                    _modeLast = (_mode == 1 || _mode == 2) ? _mode : _modeLast;
                ...
                if (_mode != 10 && ModeEnabled10 > 0
                    && ((Portfolio == null) || (Portfolio != null && Portfolio.IsShort)) 
                    && PositionStopValid && XTrend.Ma.CompareTo((double)PositionStop) > 0)
                {
                    _mode = 10;
                    _modeLast = (_mode == 1 || _mode == 2) ? _mode : _modeLast;
            ...
            {
                if (_mode == 0 && _richTarget2 && (
                    (XTrend.IsDown2 && TakeLong(ChangeModeCondSignal0)) ||
                    (XTrend.IsUp2 && TakeShort(ChangeModeCondSignal0)))
                    )
                {
                    _mode = 1;
                    _modeLast = 1;
