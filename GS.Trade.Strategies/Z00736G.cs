            ...
            if (Position.IsOpened )
            {
                ...
                else
                {
                    if (Position.Quantity < Contracts)
                    {
                        ...
                        //    : 2;
                        if (
                                (IsLong && (XTrend.Ma + VolatilityUnit2).IsLessThan(LastTradeLongMaValue)) ||
                                (IsShort && (XTrend.Ma - VolatilityUnit2).IsGreaterThan(LastTradeShortMaValue))
                           )
                           Mode = 2;
                    }
