                    ...
                    else
                    {
                        ...
                        //   )
                         if(   
                             ...
                             Position.IsLong && MyPositionStop.HasValue && MyPositionStop.IsLessThan((float)XTrend.Ma)
                             ) ||
                             (
                             //TrendMode * XTrend.Trend55.Value < 0 && 
                             //XTrend.Ma < XTrend.TrHigh1 && Position.IsShort)
                             Position.IsShort && MyPositionStop.HasValue && MyPositionStop.IsGreaterThan((float)XTrend.Ma)
                             )
                           )
                            Mode = 2;
                        else
