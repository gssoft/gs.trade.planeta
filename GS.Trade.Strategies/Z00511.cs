...
namespace GS.Trade.Strategies
{
    public class Z00511 : Z005
    {
        ...
        protected override int Entry()
        {
            ...
            {
                int longOrShort = Position.IsOpened ? LongOrShortWithOpen() : LongOrShortNoOpen();
        ...
        private int LongOrShortWithOpen()
        {
            if (!PositionMax.IsValid || !PositionMin.IsValid)
                return 0;
            if ((2 * XTrend.Ma).IsLessThan((double)(PositionMin.Value + PositionMax.Value)))
                return +1;
            return -1;
        }
        ...
        private new bool ShortEntry(int dir)
        {
            int entrySignal = 0;
            int entrySignal2 = 0;
            int entryMode = 0;
            ...
            if ((TakeShort(entrySignal) ||
                /*PositionMin.IsLessThan((float)XTrend.Ma) IsSafeEntry(-1)  &&  */ 
        ...
        private new bool LongEntry(int dir)
        {
            int entrySignal = 0;
            int entrySignal2 = 0;
            int entryMode = 0;
            ...
            if ((TakeLong(entrySignal) ||  /*PositionMax.IsGreaterThan((float)XTrend.Ma)
                IsSafeEntry(+1) && */ 
