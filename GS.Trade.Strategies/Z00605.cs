    ...
    public class Z00605 : Z006
    {
        ...
        protected override int Entry()
        {
            ...
            else if (Position.IsNeutral)
            {
                ...
                if (longOrShort < 0)
                {
                    if (ShortEntry(-1 * longOrShort))
                        return -1;
                }
                else if (longOrShort > 0)
                {
                    if (LongEntry(longOrShort))
                        return +1;
                }
                return 0;
            }
        ...
        private bool ShortEntry(int signal)
        {
            ...
            if (!TrEntryEnabled.Value)
                return false;
            if (
                (signal == 0 && Mode == 1 && TakeShort(EntrySignal11)) ||
                (signal == 0 && Mode == 2 && (TakeShort(EntrySignal11) || TakeShort(EntrySignal12))) ||
                (signal == 0 && Mode == 3 && (TakeShort(EntrySignal11) || TakeShort(ExitSignal3))) ||
        ...
        private bool LongEntry(int signal)
        {
            ...
            if (!TrEntryEnabled.Value)
                return false;
            if (
                (signal == 0 && Mode == 1 && TakeLong(EntrySignal11)) ||
                (signal == 0 && Mode == 2 && (TakeLong(EntrySignal11) || TakeLong(EntrySignal12))) ||
                (signal == 0 && Mode == 3 && (TakeLong(EntrySignal11) || TakeLong(ExitSignal3))) ||
        ...
        private void ChangeMode123()
        {
            ...
            if (Position.IsOpened)
            {
                   ...
                   )
                {
                    ...
                    Mode = Position.Quantity <= SafeContracts2 ? 2 : 3;
                    inTheSky = true;
                }
                else
                {
