    ...
    public class Z00519 : Z005
    {
        ...
        private new bool ShortEntry()
        {
            ...
            if (
                ...
                ||
                (Mode == 1  && Position.IsShort && TrEntryEnabled.Value &&
                (
               ...
               )
            {
                if (XTrend.GetPrice5(-1, EntryPriceId, out _currentLimitPrice, out _comment))
                {
                    ...
                    var sig = TakeShort(entrySignal) ? entrySignal : (TakeShort(2) ? 2 : entrySignal2);
        ...
        private new bool LongEntry()
        {
            ...
            if ((Mode == 2 && (bSig || TakeLong(entrySignal2)) && TrEntryEnabled.Value)
                ||
                (Mode == 1  && Position.IsLong && TrEntryEnabled.Value &&
                (
               ...
               )
            {
                ...
                if (XTrend.GetPrice5(+1, EntryPriceId, out _currentLimitPrice, out _comment))
                {
                    ...
                    var sig = TakeLong(entrySignal) ? entrySignal : (TakeLong(2) ? 2 : entrySignal2);
