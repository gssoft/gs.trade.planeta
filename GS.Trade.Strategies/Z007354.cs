        ...
        private void ChangeMode123()
        {
            ...
            if (Position.IsOpened )
            {
                if (Position.Quantity < Contracts)
                {
                    ...
                    //    Mode = 2;
                    //else if (Mode == 3 || Mode == 4 || Mode == 8 || Mode == 5 ||
                    //            (Mode == 2 && (_previousMode == 3 || _previousMode == 4 || _previousMode == 5 /*|| _previousMode == 8 */)))
                    //{
                        ...
                        {
                            //var posmax = XTrend.TrHigh1.IsLessThan(PositionMax.GetValidValue)
                            //    ? XTrend.TrHigh1
                            //    : PositionMax.GetValidValue;
                            //var posmin = XTrend.TrLow1.IsGreaterThan(PositionMin.GetValidValue)
                            //    ? XTrend.TrLow1
                            //    : PositionMin.GetValidValue;
                            var posmax = XTrend.TrHigh1;
                            var posmin = XTrend.TrLow1;
                            if (
                                (Position.IsLong && XTrend.Ma.IsGreaterThan(posmin)) ||
                                (Position.IsShort && XTrend.Ma.IsLessThan(posmax))
                               )
                            {
                                Mode = 8;
                            }
                        ...
                        //if (TrendMode == 3 &&
                        //    (Position.IsLong && XTrend.Ma > (double)Position.Price3) ||
                        //    (Position.IsShort && XTrend.Ma < (double)Position.Price3)
                        //   )
                        //    Mode = 2;
                        //else
                        //    Mode = 4;
