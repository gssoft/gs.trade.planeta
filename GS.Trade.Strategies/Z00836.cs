    ...
    public class Z00836 : Z008
    {
        ...
        private bool ShortEntry(int signal)
        {
            ...
            if (!TrEntryEnabled.Value)
                return false;
            if (
                (signal == 0 && IsMainTrendDown && Mode == 1 && (TakeShort(EntrySignal11) || TakeShort(EntrySignal12))) ||
                //(signal == 0 && IsMainTrendDown && Mode == 2 && Position.IsShort && (TakeShort(EntrySignal21) || TakeShort(EntrySignal22))) ||
                //(signal == 0 && IsMainTrendDown && Mode == 2 && Position.IsLong && (TakeShort(EntrySignal23) || TakeShort(EntrySignal24))) ||
        ...
        private bool LongEntry(int signal)
        {
            ...
            if (!TrEntryEnabled.Value)
                return false;
            if (
                (signal == 0 && IsMainTrendUp && Mode == 1 && (TakeLong(EntrySignal11) || TakeLong(EntrySignal12))) ||
                //(signal == 0 && IsMainTrendUp && Mode == 2 && Position.IsLong && (TakeLong(EntrySignal21) || TakeLong(EntrySignal22))) ||
                //(signal == 0 && IsMainTrendUp && Mode == 2 && Position.IsShort && (TakeLong(EntrySignal23) || TakeLong(EntrySignal24))) ||
        ...
        private void ChangeMode123()
        {
            ...
            if (Position.IsOpened )
            {
                if (Position.Quantity < Contracts)
                {
                    ...
                    Mode = (Position.IsLong && IsMainTrendUp) || (Position.IsShort && IsMainTrendDown) || IsPosPositive
                                ? 2
                                : 8;
                    // }
                }
                ...
                {
                    // if (IsPosPositive)
                    if((Position.IsLong && IsMainTrendUp) || (Position.IsShort && IsMainTrendDown) || IsPosPositive)
                    {
