            ...
            if (np.IsOpened)
            {
                if (np.Quantity >= Contracts)
                {
                    ...
                    */
                    if (np.IsLong)
                    {
                        PositionMin = float.MaxValue;
                        PositionStop = PositionMin;
                    }
                    else if (np.IsShort)
                    {
                        PositionMax = float.MinValue;
                        PositionStop = float.MaxValue;
                    }
                }
                else
                {
        ...
        protected override void Prefix()
        {
            ...
            if (IsUnSafeContracts)
            {
                if (!PositionStopValid)
                {
                    ...
                    {
                        if (XTrend.IsDown)
                            PositionStop = (float)XTrend.High2;
                    }
                    else if (Position.IsLong)
                    {
                        if (XTrend.IsUp)
                            PositionStop = (float)XTrend.Low2;
                    }
                }
                else
                {
                    ...
                    if (Position.IsLong)
                    {
                        if (XTrend.IsUp)
                        {
                            ...
                            if (min.CompareTo(PositionStop) <= 0)
                                PositionStop = min;
                        }
                    }
                }
