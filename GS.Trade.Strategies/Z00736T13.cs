...
namespace GS.Trade.Strategies
{
    public class Z00736T13 : Z007
    {
        ...
        private bool ShortEntry(int signal)
        {
            ...
            if (
                (signal == 0 && Mode == 1 && IsPrimTrendDown && (TakeShort(EntrySignal11) || TakeShort(EntrySignal12))) ||
                ...
                (IsXTrend2EntryEnable && signal == 0 && Mode == 3 && Position.IsShort && (TakeShort2(EntrySignal31) || TakeShort2(EntrySignal32))) ||
        ...
        private bool LongEntry(int signal)
        {
            ...
            //if (_swingCountEntry < SwingCountEntry && Mode != 8) return false; 
                if (
                (signal == 0 && Mode == 1 && IsPrimTrendUp && (TakeLong(EntrySignal11) || TakeLong(EntrySignal12))) ||
                ...
                (IsXTrend2EntryEnable && signal == 0 && Mode == 3 && Position.IsLong && (TakeLong2(EntrySignal31) || TakeLong2(EntrySignal32))) ||
