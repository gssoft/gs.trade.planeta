    ...
    public class Z00103 : Z001
    {
        ...
        protected override bool ShortEntry()
        {
            ...
            if (TakeShort(entrySignal) && _swingCountEntry >= SwingCountEntry &&
                (
                 ( Position.IsShort  && (_swingCountEntry >= SwingCountEntry * 2 ||
                 //Position.IsShort && (XTrend.Ma.CompareTo((double)Position.LastTradeSellPrice) > 0 ||
                    LastPositionChanged == PositionChangedEnum.ReSizedDown)) ||
        ...
        protected override bool LongEntry()
        {
            ...
            if (TakeLong(entrySignal) && _swingCountEntry >= SwingCountEntry &&
                (
                 (Position.IsLong && (_swingCountEntry >= SwingCountEntry * 2 ||
                 //Position.IsLong && (XTrend.Ma.CompareTo((double)Position.LastTradeBuyPrice) < 0 || 
                    LastPositionChanged == PositionChangedEnum.ReSizedDown)) ||
