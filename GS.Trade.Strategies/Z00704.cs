    ...
    public class Z00704 : Z007
    {
        ...
        private void ChangeMode123()
        {
            ...
            if (Position.IsOpened)
            {
                ...
                {
                    Mode = Position.Quantity <= SafeContracts2 ? 8 : 4;
                }
                if ((previousMode == 4 || previousMode == 8) && Mode == 2)
                {
                    if (IsMode2Delayed)
                    {
                        _swingCountEntry = 0;
                ...
                if ((previousMode == 4 || previousMode == 8) && Mode == 3)
                {
                    if (IsMode3Delayed)
                    {
                        _swingCountEntry = 0;
