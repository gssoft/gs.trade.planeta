...
{
    public partial class Z002 : Strategy
    {
        [XmlIgnore]
        ...
        public Z002(ITradeContext tx, string name, string code, Ticker ticker, uint timeInt)
        ...
        public override void Init()
        {
            ...
            TradeContext.EventLog.AddItem(EvlResult.SUCCESS, EvlSubject.TECHNOLOGY, StrategyTickerString, Code, "Init " + Code, ToString(), "");
        }
