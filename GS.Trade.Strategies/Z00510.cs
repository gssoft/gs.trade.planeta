    ...
    public class Z00510 : Z005
    {
        ...
        private new bool ShortEntry()
        {
            ...
            if ((TakeShort(entrySignal) ||
                ( /*PositionMin.IsLessThan((float)XTrend.Ma) IsSafeEntry(-1)  &&  */ TakeShort(entrySignal2))) && _swingCountEntry >= swCntEntry  // &&
                //  (
        ...
        private new bool LongEntry()
        {
            ...
            if ((TakeLong(entrySignal) || ( /*PositionMax.IsGreaterThan((float)XTrend.Ma)
                IsSafeEntry(+1) && */ TakeLong(entrySignal2))) && _swingCountEntry >= swCntEntry
