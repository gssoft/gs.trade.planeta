...
namespace GS.Trade.Strategies
{
    public class Z00708 : Z007
    {
        ...
        private void ChangeMode123()
        {
            ...
            if (Position.IsOpened )
            {
                if ( TrendMode * XTrend.Trend55.Value > 0 && Position.IsLong ||
                     TrendMode * XTrend.Trend55.Value < 0 && Position.IsShort
                   // (
                   //     Position.IsLong &&
                ...
                if ((previousMode == 2 || previousMode == 3) && Mode == 4)
                {
                    if (IsMode2Delayed)
                    {
                        _swingCountEntry = 0;
                ...
                if ((previousMode == 2 || previousMode == 3) && Mode == 8)
                {
                    if (IsMode3Delayed)
                    {
                        _swingCountEntry = 0;
