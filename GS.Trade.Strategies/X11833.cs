    ...
    public class X11833 : X118
    {
        ...
        private bool ChangeMode()
        {
            if( Position.IsLong)
            {
                ...
                if (_mode == 1 && _richTarget5 && TakeShort(ChangeModeCondSignal5) && _swingCountReverse >= SwingCountReverse)
                {
                    _mode = 5;
                ...
                if (_mode == 2 && _richTarget5 && TakeShort(ChangeModeCondSignal5) && _swingCountReverse >= SwingCountReverse)
                {
                    _mode = 5;
            ...
            else if ( Position.IsShort )
            {
                ...
                if (_mode == 1 && _richTarget5 && TakeLong(ChangeModeCondSignal5) && _swingCountReverse >= SwingCountReverse)
                {
                    _mode = 5;
                ...
                if (_mode == 2 && _richTarget5 && TakeLong(ChangeModeCondSignal5) && _swingCountReverse >= SwingCountReverse)
                {
                    _mode = 5;
