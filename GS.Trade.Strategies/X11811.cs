...
namespace GS.Trade.Strategies
{
    public class X11811 : X118
    {
        ...
        public int RichTargetMode1 { get; set; }
        ...
        protected override bool ShortReverse()
        {
            ...
            if (_mode == 1 && IsRiskLowMap(1) && PositionMaxValid && XTrend.Ma.CompareTo(PositionMax) > 0)
            {
            ...
            // RichTarget2. Enter Mode2
            if (_mode == 1 && _richTarget2  && XTrend.TakeLong(ReverseSignal1)  && _swingCountReverse >= SwingCountReverse)
            {
                _mode = 2;
                _richTarget1 = false;
                _richTarget2 = false;
            ...
            if ( (_mode == 1 || _mode == 2) && !_richTarget2 && _richTarget1 && ReverseSignal1 > 0 && XTrend.TakeLong(ReverseSignal1) && _swingCountReverse >= SwingCountReverse)
            {
            ...
            if (_mode == 2 && _richTarget2  && IsRiskLowMap(2)  && ReverseSignal2 > 0 && XTrend.TakeLong(ReverseSignal2) && _swingCountReverse >= SwingCountReverse)
            {
                if (XTrend.GetPrice5(+1, ReversePriceId, out _currentLimitPrice, out _comment))
                {
        ...
        protected override bool LongReverse()
        {
            ...
            if (_mode == 1 && IsRiskLowMap(1) && PositionMinValid && XTrend.Ma.CompareTo(PositionMin) < 0)
            {
                if (XTrend.GetPrice5(-1, ExitPriceId, out _currentLimitPrice, out _comment))
                {
                    _tryEnterMode = 2;
            ...
            if (_mode == 1 && _richTarget2   && XTrend.TakeShort(ReverseSignal1)  && _swingCountReverse >= SwingCountReverse)
            {
                _mode = 2;
                _richTarget1 = false;
                _richTarget2 = false;
            ...
            // Reverse After Profit
            if ( (_mode == 1 || _mode == 2) && !_richTarget2 && _richTarget1 && ReverseSignal1 > 0 && XTrend.TakeShort(ReverseSignal1) && _swingCountReverse >= SwingCountReverse)
            {
                if (XTrend.GetPrice5(-1, ReversePriceId, out _currentLimitPrice, out _comment))
                {
            ...
            // Reverse After Profit
            if (_mode == 2 && _richTarget2 && IsRiskLowMap(2) && ReverseSignal2 > 0 && XTrend.TakeShort(ReverseSignal2)
        ...
        protected override bool ShortExit()
        {
            ...
            if (_mode == 2 && _richTarget2 && ExitSignal2 > 0 && XTrend.TakeLong(ExitSignal2) && _swingCountExit >= SwingCountExit)
            {
                if (XTrend.GetPrice5(+1, ExitPriceId, out _currentLimitPrice, out _comment))
                {
        ...
        protected override bool LongExit()
        {
            ...
            if (_mode == 2 && _richTarget2 && ExitSignal2 > 0 && XTrend.TakeShort(ExitSignal2) && _swingCountExit >= SwingCountExit)
            {
                if (XTrend.GetPrice5(-1, ExitPriceId, out _currentLimitPrice, out _comment))
                {
