    ...
    public class Z00701 : Z007
    {
        ...
        private bool ShortEntry(int signal)
        {
            ...
            if (!TrEntryEnabled.Value)
                return false;
            if (
                (signal == 0 && Mode == 1 && (TakeShort(EntrySignal11) || TakeShort(EntrySignal14))) ||
                (signal == 0 && Mode == 2 && (TakeShort(EntrySignal21) || TakeShort(EntrySignal22))) ||
                (signal == 0 && Mode == 3 && (TakeShort(EntrySignal31) || TakeShort(EntrySignal32))) ||
        ...
        private bool LongEntry(int signal)
        {
            ...
            if (!TrEntryEnabled.Value)
                return false;
            if (
                (signal == 0 && Mode == 1 && (TakeLong(EntrySignal11) || TakeLong(EntrySignal14))) ||
                (signal == 0 && Mode == 2 && (TakeLong(EntrySignal21) || TakeLong(EntrySignal22))) ||
                (signal == 0 && Mode == 3 && (TakeLong(EntrySignal31) || TakeLong(EntrySignal32))) ||
