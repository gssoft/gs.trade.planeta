...
{
    public partial class Z003 : Strategy
    {
        [XmlIgnore]
        ...
        public override string PositionInfo
        {
            get
            {
                return String.Format("PosMax: {0:N2} PosMin: {1:N2} PosStop: {2:N2}",
        ...
        public Z003(ITradeContext tx, string name, string code, Ticker ticker, uint timeInt)
        ...
        public override void Init()
        {
            ...
            // Position.PositionChangedEvent2 += PositionIsChangedEventHandler2;
        ...
        private void PositionIsChangedEventHandler(long oldposition, long newposition)
        {
            ...
            TradeContext.EventLog.AddItem(EvlResult.ATTENTION, EvlSubject.TRADING, StrategyTickerString, StrategyTickerString, "PositionChanged",
        ...
        protected override void PositionIsChangedEventHandler2(IPosition2 oldposition, IPosition2 newposition, PositionChangedEnum changedResult)
        {
            ...
            if (changedResult == PositionChangedEnum.ReSizedUp || changedResult == PositionChangedEnum.ReSizedDown)
            {
                _swingCountReverse = 0;
                _swingCountEntry = 0;
            }
        ...
        public override void Main()
        {
            ...
            if (Position.IsShort)
            {
                ...
                if (ShortExit())
                {
                    ...
                    SetOrder2(OrderOperationEnum.Buy, Position.Quantity);
                    return;
                }
                #endregion
            ...
            else if (Position.IsLong)
            {
                ...
                if (LongExit())
                {
                    ...
                    SetOrder2(OrderOperationEnum.Sell, Position.Quantity);
                    return;
                }
            ...
            if (PositionTotal.Quantity != 0 || 1 == 1)
            {
        ...
        protected virtual void PositionChanged(IPosition op, IPosition np, PositionChangedEnum result)
        {
        }
