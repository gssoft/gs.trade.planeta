...
{
    //public class WebClient05 : Element1<string>, IDisposable, IWebClient
    //{
    //   // [XmlIgnore]
    ...
    //    public WebClient05(string baseAddress, string mediaType, string apiPrefix)
    //    {
    ...
    //        return true;
    //    }
    //    public bool PostFromQueueAsync<T>()
    //    {
    //        long postCnt = 0;
    //        while (Queue.Count > 0)
    //        {
