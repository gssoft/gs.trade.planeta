...
select top 5 Cast( o.Created as Date) dt, Count(*) OrdersCount
from Orders o
...
select top 5 Cast( DT as Date) dt, Count(*) TradesCount
from Trades o
...
-- DEALS
Select 'Deals Delete'
select top 5 Cast( DT as Date) dt, Count(*) DealsCount
from Deals o
Group by Cast( DT as Date)
Order by Cast( DT as Date) DESC
GO
...
select top 5 Cast( DT as Date) dt, Count(*) EvlisCount
