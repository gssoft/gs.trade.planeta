...
namespace GS.ProcessTasks
{
    public class ProcessTask<TInput> : Element35<string, TInput, IEventArgs1>, IDisposable
    {
        ...
        public void Start()
        {
            ...
            {
                Evlm2(EvlResult.FATAL, EvlSubject.TECHNOLOGY, ParentName, Name,
                    "Starting()", "Failed to Start: ItemProcessingAction is NULL", TaskStatusStr);
                return;
            }
        ...
        private void WaitingForCompletion()
        {
            ...
            {
                Evlm2(EvlResult.INFO, EvlSubject.TECHNOLOGY, ParentName, GetType().Name,
            ...
            if (!TaskIsFinised)
            {
                Evlm2(EvlResult.FATAL, EvlSubject.TECHNOLOGY, ParentName, GetType().Name,
        ...
        //public override void ItemsProcessing(IEnumerable<TInput> items)
        //{
        //    foreach (var i in items)
        //    {
        //        try
