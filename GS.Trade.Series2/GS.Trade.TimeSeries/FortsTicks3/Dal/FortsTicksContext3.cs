...
{
    public partial class FortsTicksContext3 : DbContext
    {
        public FortsTicksContext3() : base("FortsTicks03")
        //public FortsTicksContext()
        //    : base(@"Data Source=.\MSSQL12;Initial Catalog=FortsTicks01;Integrated Security=True")
        {
            Database.CommandTimeout = 300;
        }
        public FortsTicksContext3(string connetionStringKey)
        ...
        public IQueryable<Model.BarSeries> BarSeriesSet => TimeSeries.OfType<Model.BarSeries>();
        public IQueryable<Model.TickSeries> TickSeriesSet =>  TimeSeries.OfType<TickSeries>();
        public IQueryable<Model.FileSeries> FileSeriesSet => TimeSeries.OfType<Model.FileSeries>();
