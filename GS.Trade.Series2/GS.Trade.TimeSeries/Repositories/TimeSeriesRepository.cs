...
namespace GS.Trade.TimeSeries.Repositories
{
    ...
    public interface ITimeSeriesRepository : IEntityRepository<ITimeSeriesBase2, ITimeSeries2>
    {
    }
    ...
    public interface IBarsRepository3 : IEntityRepository<IBarDb, IBar>,
        IHaveWork<IEventArgs>,
        IHaveEnQueue<IEventArgs>
    {
    }

    public class BarSeriesRepository33 :
                   TradeBaseRepository33<TimeSeriesContext, string, ITimeSeries2, TimeSeries, ITimeSeriesBase2>,
                   ITimeSeriesRepository
    {
        ...
        protected override bool AddVal(TimeSeriesContext cntx, ITimeSeries2 a)
        {
            var dt = DateTime.Now;
            //try
            //{
        ...
        protected override ITimeSeries2 Update(TimeSeriesContext cntx, ITimeSeries2 ve, TimeSeries vi) // AddOrGet
        {
            ve.Id = vi.Id;
            ve.Code = vi.Code;
            ve.Name = vi.Name;
        ...
        protected override bool Update(TimeSeriesContext cntx, TimeSeries vi, ITimeSeries2 ve)
        {
            //try
            //{
            if (ve == null)
                ...
                IBarsRepository3
    {
        ...
        {
            var tqe = new TradeQueueEntity<IBar>(StorageOperationEnum.Add, (IBar)(queueItem.Object));
