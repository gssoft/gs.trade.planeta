...
{
    public class TicksFromTxtToDb3 : Element1<string>, IBatchWorkItem
    {
        ...
        public void DoWork()
        {
            try
            {
                Database.SetInitializer(new FortsTicks3.Init.Initializer());
        ...
        private void AddTicks()
        {
            try
            {
                ...
                using (var context = new FortsTicksContext3(ConnectionString))
                {
        ...
        private void UpdateTicksStatAll()
        {
            try
            {
                using (var db = new FortsTicksContext3(ConnectionString))
                {
