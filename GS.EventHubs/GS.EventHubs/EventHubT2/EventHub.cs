...
namespace GS.EventHubs.EventHubT2
{
    public partial class EventHub<TEventArgs, TContent> : 
        DictionaryCollection<string, IEventHubItem<TContent>>, IEventHubType<TEventArgs, TContent>
        where TEventArgs : IHaveContent<TContent>
    {
        ...
        public void EnQueue(TEventArgs args)
        {
            try
            {
        ...
        public void EnQueue(object sender, TEventArgs args)
        {
            EnQueue(args);
        }
        protected void FireEventOperation(TEventArgs args)
        {
            try
            {
