...
{
    public partial class TcpServer04<TEventArgs, TContent> : Element32<string, IEventArgs1,
        DictionaryContainer<string, ITcpClientHandler>, ITcpClientHandler>, ITcpServer<TEventArgs, TContent> 
        where TEventArgs : IHaveContent<TContent>
    {
        ...
        public void SendMessage(TEventArgs args)
        {
        ...
        public void Subscribe(string topicKey, EventHandler<TContent> callback, ITcpClientHandler tcpHandler)
        {
            var m = MethodBase.GetCurrentMethod().Name + "()";
            try
            {
