...
{    
    public partial class TcpClientHandler<TMessage> : Element1<string>,
        ITcpClientHandler<TMessage>
        where TMessage : IHaveIndex<string>
    {
        ...
        private void TcpNetworkStreamReadProcess(CancellationToken canceltoken)
        {
            ...
            while (_working)
            {
                try
                {
                    ...
                    var dto = BinarySerialization.DeSerialize<TMessage>(dtoBytes);
        ...
        public void SendMessage(IHaveContent<TMessage> message)
        {
            ProcessTask.EnQueue(message.Content);
        }
        ...
        private void Register(TcpClientHandler<TMessage> tcpClientHandler)
        {
            var m = MethodBase.GetCurrentMethod().Name + "()";
