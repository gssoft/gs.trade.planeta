...
{
    public partial class TcpClientHandler : ITcpClientHandler
    {
        ...
        private void TcpServerMessageRecievedProcessing(List<string> dto)
        {
        ...
        private void TcpClientMessageRecievedProcessing(List<string> dto)
        {
            var m = MethodBase.GetCurrentMethod().Name + "()";
