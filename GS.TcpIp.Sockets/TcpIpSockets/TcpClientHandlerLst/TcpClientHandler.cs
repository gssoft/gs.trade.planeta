...
using ITcpClientHandler = TcpIpSockets.TcpClientHandlerLst.ITcpClientHandler;
using ITcpServer = TcpIpSockets.TcpClientHandlerLst.ITcpServer;

namespace TcpIpSockets.TcpClientHandlerLst
{    
    public partial class TcpClientHandler : Element1<string>, ITcpClientHandler
    {
        ...
        private void TcpNetworkStreamReadProcess(CancellationToken canceltoken)
        {
            ...
            while (_working)
            {
                try
                {
                    ...
                    var dto = BinarySerialization.DeSerialize<List<string>>(dtoBytes);
