...
namespace GS.Trade.TradeTerminals.Quik
{
                                ...
                                IQuikTradeTerminal, ITrans2QuikReceiver
    {
        ...
        public delegate void TransactionReplyEventHandler(int result, UInt32 trid, ulong ordernumber );
...
#region Transaction
                    ...
                    [MarshalAs(UnmanagedType.LPStr)] string replyMessage)
        {
            ...
            TransactionReplyEvent?.Invoke(nResult, dwTransId, ordernum);
            ...
            if (t == null)
            {
                ...
                //{
                    Evlm2(EvlResult.FATAL, EvlSubject.TECHNOLOGY, "Quik.TransactionReply",
                        $"{(uint) dwTransId} Orders Transaction  NOT FOUND",
                        replyMessage,
