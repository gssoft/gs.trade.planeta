...
namespace GS.Trade.TradeTerminals.Quik
{
    public sealed partial class QuikTradeTerminal
    {
        ...
        public void TradeResolveProcess2()
        {
            ...
            try
            {
                foreach (var t in TradesToProcess.TradeConfirmed)
                {
                    ...
                    Evlm2(EvlResult.SUCCESS, EvlSubject.TRADING, DllNamePath2QuikPair,
                        ...
                        $"{methodname} Trade Resolved", t.ShortInfo, t.ToString());
                    /*
            ...
            {
                SendExceptionMessage3(FullName, methodname, methodname, "", e);
            }
        }
        private bool TryToResolveTrade(ITrade3 t)
        {
            ...
            {
                SendExceptionMessage3(FullName, t.GetType().FullName, methodname, t.ToString(), e);
                return false;
            }
        }
    }
