...
namespace GS.Trade.TradeTerminals
{
    ...
    public interface ITransaction : Containers5.IHaveKey<long>
    {
        DateTime DT { get; }
    ...
    public interface IQuikTransaction : ITransaction, IProccesingAction<IQuikTransaction>
    {
        long TransID { get; }
    ...
    public class QuikTransactions : DictionaryCollection< long, IQuikTransaction>// Containers5.DictionaryContainer<long, IQuikTransaction>
    {
