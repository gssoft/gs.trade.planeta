...
namespace GS.Trade.TradeTerminals.Simulate
{
    public class SimulateTerminal : Element1<string>, GS.Trade.ITradeTerminal, ISimulateTerminal
    {
        ...
        {
            if (NewOrderStatusEvent != null) NewOrderStatusEvent();
        }
        ...
        public long SetMarketOrder(string account, string strategy, string tickercategory, string tickercode, OrderOperationEnum operation, double price, long quantity)
        {
            var n = (ulong)GetUnicID();
            var dt = DateTime.Now;
            var o = new Order(n, dt, 1, account, strategy, tickercode, operation, OrderTypeEnum.Market, 0,
                              price, (int)quantity, (int)quantity, OrderStatusEnum.Activated, n, "", DateTime.Now.TimeOfDay, DateTime.Now.TimeOfDay);
            return (long)n;
        }
