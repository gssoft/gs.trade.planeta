        ...
        public Work Work {
            ...
            set
            {
                if (value == null)
                {
                    ...
                    OnExceptionEvent(new NullReferenceException($"WorkProcess: {Code} Work is Null"));
                }
                else
                {
                    _work = value;
                    ...
                    //{
                        if (IsEnabled)
                        {
                            ...
                            if (!Work.Main())
                            {
                                IsEnabled = false;
                                StopReason =
                                    $"WorkTask: {Code} Try To Stop;\r\nReason: Work: {Work.Code}: Error in Work.Main. work.Meassage: {Work.Message}";
                                Stop();
                            }
