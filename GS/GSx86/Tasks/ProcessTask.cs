...
namespace GS.Tasks
{
    public class ProcessTask05<TInput> : Element35<string, TInput, IEventArgs1>, IDisposable
    {
        ...
        private async void TestAsync()
        {
            try
            {
                WaitingForCompletion02().Wait(TimeSpan.FromSeconds(15));
                await WaitingForCompletion02();
            }
            catch (Exception e)
            {
        ...
        private Task WaitingForCompletion02()
        {
