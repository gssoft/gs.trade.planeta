...
{
    public class AccountRepository32 :
                    TradeBaseRepository32<string, IAccount, Model.Account, IAccountDb>,
    ...
    public class TickerRepository32 :
                    TradeBaseRepository32<string, ITicker, Model.Ticker, ITickerDb>,
    ...
    public class StrategyRepository32 :
                    TradeBaseRepository32<string, IStrategy, Model.Strategy, IStrategyDb>,
    ...
    public class OrderRepository32 :
                    TradeBaseRepository32<string, IOrder3, Model.Order, IOrderDb>,
    ...
    public class TradeRepository32 :
                    TradeBaseRepository32<string, ITrade3, Model.Trade, ITradeDb>,
    ...
    public class PositionRepository32 :
                    TradeBaseRepository32<string, IPosition2, Model.Position, IPositionDb>,
    ...
    public class PositionTotalRepository32 :
                    TradeBaseRepository32<string, IPosition2, Model.Total, IPositionDb>,
                    IEntityRepository<IPositionDb, IPosition2> // IPositionTotalRepository
    {
        ...
        protected override bool AddVal(DbTradeContext cntx, IPosition2 p)
        {
            ...
            {
                if (p.Strategy == null || p.Strategy.Id == 0)
                    throw new ArgumentNullException("p", "PositionTotalRepository32.AddVal(Total)");
    ...
    public class DealRepository32 :
                    TradeBaseRepository32<string, IDeal, Model.Deal, IDealDb>,
                    IEntityRepository<IDealDb, IDeal>     //IDealRepository
    {
        ...
        protected override IDeal Update(DbTradeContext cntx, IDeal ve, Deal vi)
        {
            try
            {
                if (vi?.Strategy == null || vi.Strategy.Id == 0)
