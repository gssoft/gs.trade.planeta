...
{
    public abstract class TradeBaseRepository33<TContext, TKey, TValueExt, TValueInt, TValueIntOut> :
                         Element1<string>,
        ...
        where TContext : IDisposable
    {
        ...
        protected TradeBaseRepository33()
        {
            _locker = new object();
            _locker2 = new object();
        ...
        public bool Add(TValueExt ve)
        {
            ...
            try
            {
                if (ve == null)
                {
                    ...
                    var e = new ArgumentNullException(nameof(ve), FullName + " Add()");
        ...
        public bool Add(IEnumerable<TValueExt> ave)
        {
            ...
            try
            {
                if (ave == null)
                {
                    ...
                    var e = new ArgumentNullException(nameof(ave), FullName + " Add(IEnumerable<TValueExt>)");
                    SendException(null, method, e);
                    return false;
                }
                lock (_locker)
        ...
        public bool AddNew(TValueExt ve)
        {
            ...
            try
            {
                if (ve == null)
                {
                    ...
                    var e = new ArgumentNullException(nameof(ve), FullName + " AddNew()");
                    SendException(null, method, e);
                    return false;
                }
                bool ret;
        ...
        public TValueExt AddOrGet(TValueExt ve)
        {
            ...
            try
            {
                if (ve == null)
                {
                    ...
                    var e = new ArgumentNullException(nameof(ve), FullName + " AddOrGet()");
                    SendException(null, method, e);
                    return null;
                }
                TValueExt ret = ve;
        ...
        public bool Update(TValueExt ve)
        {
            ...
            try
            {
                if (ve == null)
                {
                    ...
                    var e = new ArgumentNullException(nameof(ve), FullName + " Update()");
                    SendException(null, method, e);
                    return false;
                }
                bool ret;
        ...
        {
            var type = ve?.GetType().ToString() ?? "Entity";
            var entity = ve?.ToString() ?? "Entity";
