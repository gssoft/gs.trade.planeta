...
namespace GS.Trade.Store
{
    public class DbStorage : Storage.TradeStorage, ITradeStorage
    {
        ...
        public int SaveChanges(StorageOperationEnum operation, IPosition2 p)
        {
            if (p == null)
            {
                SendExceptionMessage(Name, "DbStorage.SaveChanges(IPosition2==NULL)", "Null reference");
                return -1;
            ...
            var t = Task.Factory.StartNew(() =>
            {
                ...
                {
                    SendExceptionMessage("DbStorage.SaveChanges(IPosition2)", e.Message, e.Source);
                    throw;
                }
            });
            return 1;
        ...
        public int SaveChanges(StorageOperationEnum operation, IPositionTotal2 p)
        {
            if (p == null)
            {
                SendExceptionMessage(Name, "DbStorage.SaveChanges(IPositionTotal2==Null)", "Null reference");
                return -1;
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                {
                    SendExceptionMessage("DbStorage.SaveChanges(IPositionTotal2)", e.Message, e.Source);
                    throw;
                }
        ...
        public int SaveChanges(StorageOperationEnum operation, IDeal p)
        {
            if (p == null)
            {
                SendExceptionMessage("DbStorage.SaveChanges(IDeal==Null)", "Null reference", "");
                return -1;
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                {
                    SendExceptionMessage("DbStorage.SaveChanges(IDeal)", e.Message, "");
                    throw;
                }
            });
            return 1;
        ...
        public int SaveTotalChanges(StorageOperationEnum operation, IPosition2 p)
        {
            if (p == null)
            {
                SendExceptionMessage("DbStorage.SaveTotalChanges(IPositionTotal2==Null)", "Null reference", "");
                return -1;
                //throw new NullReferenceException("DbStorage.SaveChanges(IPositionTotal2) Failure:");
            }
            var t = Task.Factory.StartNew(() =>
            {
                ...
                {
                    SendExceptionMessage("DbStorage.SaveTotalChanges(IPositionTotal2)", e.Message, e.Source);
                    throw;
                }
            });
            return 1;
        ...
        public int SaveDealChanges(StorageOperationEnum operation, IPosition2 p)
        {
            ...
            var t = Task.Factory.StartNew(() =>
            {
                ...
                {
                    SendExceptionMessage("DbStorage.SaveDealChanges(IPosition2)", e.Message, "");
                    throw;
                }
            });
            return 1;
