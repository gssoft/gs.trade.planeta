...
namespace GS.Trade.Store
{
    ...
    public class Store<TKey, TItem> : Element, IHaveUri, IStore<TKey, TItem> 
        where TItem : class, IHaveKey<TKey>, IHaveInit //  Containers5.ListContainer<string, TItem>,  IStorages<TItem> where TItem : class, IHaveKey<string>
    {   [XmlIgnore]
