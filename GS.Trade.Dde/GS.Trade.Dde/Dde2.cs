...
namespace GS.Trade.Dde
{
    ...
    public class Dde2 : Element2<string, TopicItem,
                        Containers5.DictionaryContainer<string, TopicItem>>, IDde2
    {
        ...
        public Dde2()
        {
            Collection = new DictionaryContainer<string, TopicItem>();
        }
        ...
        public override void Init(IEventLog evl)
        {
            ...
            Evlm2(EvlResult.SUCCESS, EvlSubject.TECHNOLOGY, "Dde", Code, "Initialization", FullName, ToString());
        }
        ...
        //    });
        //}
        private TopicItem RegisterTopic(string topicItem)
        {
            if (DefaultCallBack == null)
                throw new NullReferenceException("Topic=" + topicItem + " Is Not Found and DefaultCallBack == Null");
    ...
    public class TopicItem : Element1<string>, ITopicItem
    {
        public string TopicItemKey { get; set; }
    
        [XmlIgnore]
        public Action<string> Action { get; set; }
        public override string Key => TopicItemKey;
    }
}
