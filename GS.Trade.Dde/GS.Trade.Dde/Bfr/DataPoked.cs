...
namespace GS.Trade.Dde.Bfr
{
    public partial class Dde
    {
        private void DataPoked(object sender, DataPokeddEventArgs args)
        {
            ...
            try
            {
                ProcessTaskDataPoked.EnQueue(args);
            }
            catch (Exception e)
            {
                SendException(e);
        ...
        // Mode = Line
        private void DataPoked1(DataPokeddEventArgs e)
        {
            try
            {
                int ndxRow;
        ...
        private void CheckCallBacks()
        {
            ...
            foreach (var i in Enumerable.Where<ITopicItem>(Collection.Items, i => i.Action == null))
            {
