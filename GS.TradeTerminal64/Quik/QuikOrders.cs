...
namespace GS.Trade.TradeTerminals64.Quik
{
    ...
    {
        public IQuikTransaction CreateQuikTransaction(IOrder3 o, IStrategy strategy, ulong transID,
...
"TRANS_ID=TransID;ACCOUNT=Account;CLASSCODE=ClassCode;SECCODE=SecCode;BASE_CONTRACT=BaseContract;ACTION=Action;";
        ...
        public long SetLimitOrder(IOrder3 o)
        {
            ...
            var t = CreateQuikTransaction(o, o.Strategy, ulong.Parse(trId),
                       ...
                       DateTime expireDateTime, string comment)
        {
            ...
            // var ret = SendSyncTransaction(orderStr);
            //var ret = SendAsyncTransaction(orderStr);
            var t = CreateQuikTransaction(null, strat, ulong.Parse(trId), QuikTransactionActionEnum.SetLimit, orderStr);
                        ...
                        DateTime expireDateTime, string comment)
        {
            ...
            var t = CreateQuikTransaction(null, null, ulong.Parse(trId), QuikTransactionActionEnum.SetLimit, orderStr);
            var ret = SendAsyncTransaction(t);
        ...
        //    return 0;
        //}
        public int KillLimitOrder(IOrder3 o, IStrategy strategy, string classcode, string seccode, ulong orderkey)
        {
            var orderStr = KillOrderStr;
            var trId = GetTransID();
            orderStr = orderStr.Replace("TransID", trId);
            ...
            //SendAsyncTransaction(orderStr);
            var t = CreateQuikTransaction(o, strategy, ulong.Parse(trId), QuikTransactionActionEnum.KillLimit, orderStr);
        ...
        public int KillLimitOrder(IOrder3 o)
        {
            ...
            var t = CreateQuikTransaction(o, o.Strategy, ulong.Parse(trId), QuikTransactionActionEnum.KillLimit, orderStr);
