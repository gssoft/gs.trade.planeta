...
{
    public partial class Dde : Element1<string>
    {
        ...
        private readonly Topics _ddeTopics = new Topics();

        private object _ddeLocker = new object();
        ...
        private void DataPoked(object sender, DataPokeddEventArgs e)
        {
            ...
            for (ndxRow = 0; ndxRow < ndxRowMax; ndxRow++)
            {
                ...
                for (ndxColl = 0; ndxColl < ndxCollMax; ndxColl++)
                {
                    ...
                    else if (e.Cells[ndxRow][ndxColl].GetType() == typeof(FTFHelper.PREVIEWVALUE))
        ...
        public Topics.Topic RegisterTopic(string topicKey, string topicName, DdeChannelOnPoked cb)
        {
